...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-200 py-4" style={{ backgroundColor: colors.primary.bone }} >
      <Container marginLeft="5vw" marginRight="5vw" >
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8" >
          <div className="col-span-1">
            ...
            <p className={`${typography.body.base} text-black mb-4 font-bold`}><strong>Style that makes you shine. </strong></p>
          </div>
