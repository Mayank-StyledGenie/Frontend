...
const Header = () => {
  ...
  return (
    <header className={`py-4 border-b border-gray-200`} style={{ backgroundColor: colors.primary.bone }}> 
      <Container marginLeft="5vw" marginRight="5vw">
        <div className="flex items-center justify-between h-14"> 
          ...
          <nav className={`${typography.body.base} hidden md:flex items-center space-x-8`}>
            <Link href="/services" className="black hover:text-black">
              Services
            </Link>
            <Link href="/freelance" className="black hover:text-black">
              Freelance
            </Link>
            <Link href="/aboutus" className="black hover:text-black">
              About
            </Link>
          </nav>
      ...
      >
        ...
        <nav className="py-4">
          <Link 
            href="/services" 
            className="block px-4 py-3 black hover:bg-gray-100"
            onClick={() => setIsDrawerOpen(false)}
          >
            Services
          </Link>
